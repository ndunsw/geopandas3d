...
class TestGeoDataFrame3D:
    ...
    def test_creation_from_points(self):
        ...
        gdf3d = GeoDataFrame3D.from_points(points, data, crs="EPSG:4979", height_col="altitude")
    ...
    def test_creation_from_polygons(self):
        ...
        gdf3d = GeoDataFrame3D.from_polygons(polygons, crs="EPSG:4979", height_col="altitude")
