...
try:
    from geopandas3d import GeoDataFrame3D, plot3d
    from geopandas3d import distance3d, centroid3d, polygon_area3d, is_point_in_polygon3d
...
def main():
    ...
    try:
        # Run all demos
        gdf3d_basic = demo_basic_3d_creation()
        points_gdf = demo_3d_points()
        polygons_gdf = demo_3d_polygons()
